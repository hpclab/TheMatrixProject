...
public class ProductModule$role$evaluation$11 implements SemanticAction {
  public void apply(ASTNode n) {

      List<ProductFilterCondition> filters = AttributeList.collectFrom(n.ntchild(0), "filter");
