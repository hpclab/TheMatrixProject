...
public class DropModule$role$evaluation$0 implements SemanticAction {
  public void apply(ASTNode n) {
       ...
       MatrixModule m = new MatrixDrop(n.ntchild(0).getValue("moduleId").toString(), inputTable, schemaName, fieldNames);
