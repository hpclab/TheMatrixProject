...
/**
 * Max implements the maximum AggregateFunction, defined on INT, FLOAT and
   ...
   @Override
    public void compute(Symbol<?> r) {
      ...
      if (o == null || r.type == DataType.MISSING) {
    	  LogST.logP(1, "** WARNING **: null value when computing "+this.getClass().getName());
    	  return;
      } 
