 ...
 */
public class SortPERSON_test extends MatrixBaseTestCase {
	...
	public void testScript0() throws IOException {
		...
		final String src = Dynamic.getScriptPath()+"SortPERSON_test.txt";
...
//		TheMatrixSys.setParams(new Symbol<Date>("DATE",DateUtil.parse("2011-01-01"),DataType.DATE)); // no params in this test
        ...
        MatrixModule out = new MatrixFileOutput("SCRIPTSORTPERSON_TEST", m);
        out.setup();
        int i=0;
